...
var DashboardComponent = (function () {
    function DashboardComponent(_appConfig, _dashboardService) {
        ...
        this.sumaMes = 0;
        this.sumaSemana = 0;
        this._dashboardService.getListadoIngresos().then(function (res) {
            _this.listadoIngresos = res.listadoIngresos;
        });
        this._dashboardService.getSumaFacturas().then(function (res) {
            console.log(res);
            _this.sumaMes = res.mes;
            _this.sumaSemana = res.semana;
        });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dashboard_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/dashboard.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__todo_todo_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/todo/todo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__chat_chat_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/chat/chat.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__feed_feed_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/feed/feed.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__datamap_datamap_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/datamap/datamap.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__dynamic_chart_dynamic_chart_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/dynamic-chart/dynamic-chart.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_chart_js_dist_Chart_js__ = __webpack_require__("../../../../chart.js/dist/Chart.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_chart_js_dist_Chart_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_15_chart_js_dist_Chart_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_endpoint_service__ = __webpack_require__("../../../../../src/app/services/endpoint.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_8__dashboard_component__["a" /* DashboardComponent */], pathMatch: 'full' }
];
...
DashboardModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__datamap_datamap_component__["a" /* DatamapComponent */],
            __WEBPACK_IMPORTED_MODULE_13__dynamic_chart_dynamic_chart_component__["a" /* DynamicChartComponent */]
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_16__services_endpoint_service__["a" /* EndPointService */], __WEBPACK_IMPORTED_MODULE_0__services_user_service__["a" /* UserService */]]
    })
], DashboardModule);
...
var DashboardService = (function () {
    function DashboardService(_ep) {
        this._ep = _ep;
    }
    DashboardService.prototype.getListadoIngresos = function () {
        return this._ep.getListadoIngresos().then(function (res) {
            return res;
        });
    };
    DashboardService.prototype.getFacturas = function () {
        return this._ep.getListadoIngresos().then(function (res) {
            return res;
        });
    };
    DashboardService.prototype.getSumaFacturas = function () {
        return this._ep.getFacturaMes().then(function (res) {
            return res;
        });
    };
